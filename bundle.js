...
/******/ 	var hotCurrentHash = "2be79c680d401f1c976a"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ShoppingList = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var displayItem = function displayItem(item, itemIndex) {
	        ...
	        return React.createElement(
	            ...
	            this.props.items.map(function (task, taskIndex) {
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        'button',
	                        { onClick: _this.props.deleteTask, value: taskIndex },
	                        ' Delete '
	                    )
	                );
	            })
	...
	var ShoppingListContainer = React.createClass({
	    displayName: 'ShoppingListContainer',
	    ...
	    deleteItem: function deleteItem(e) {
	        ...
	        console.log('remove task: %d', itemIndex, this.state.items[itemIndex]);
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'p',
	                null,
	                'Add your items below, or choose from popular items! Check off as you go and delete what you don\'t need.'
	            ),
	            React.createElement(
	                'form',
	                { onSubmit: this.addItem },
	                React.createElement('input', { onChange: this.onChange, type: 'text', value: this.state.input }),
	                React.createElement(
	                    'button',
	                    null,
	                    ' Add Task '
	            ...
	            React.createElement(ShoppingList, { items: this.state.items, deleteItem: this.deleteItem }),
	            React.createElement(
	                'button',
	                null,
	                ' Clear '
	...
	React.render(React.createElement(ShoppingListContainer, null), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ansiHTML = __webpack_require__(172);
	var colors = {
	...
	var Entities = __webpack_require__(173).AllHtmlEntities;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  Html4Entities: __webpack_require__(174),
